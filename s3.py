...
stars_line_radius = int(105 * width_ratio)
...
bg = BG((255, 0, 0), (255, 0, 255), (0, 0, 255), (0, 255, 255), (0, 255, 0), (255, 255, 0), (255, 0, 0))
...
while True:
    ...
    for i, star in enumerate(stars):
        ...
        if actual_distance and actual_distance < mouse_line_radius:
            ...
            star.x += new_x_dis - x_distance
            star.y += new_y_dis - y_distance
        ...
        for other in stars[i + 1 :]:
            ...
            if actual_dis and actual_dis < stars_line_radius:
                line_width = int(stars_line_radius / actual_dis * 2)
